...
class Kidsa_Recent_Post_Widget extends WP_Widget

{
    public function __construct()
    {
        parent::__construct(
            'kidsa_popular_posts',
            esc_html__('Kidsa: Recent Posts with Thumbnails', 'kidsa-core'),
...
if (!function_exists('Kidsa_Recent_Post_Widget')) {

    function Kidsa_Recent_Post_Widget()

    {
        register_widget('Kidsa_Recent_Post_Widget');
    }

    add_action('widgets_init', 'Kidsa_Recent_Post_Widget');
