...
class Kidsa_Category_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'kidsa_category',
            esc_html__( 'Kidsa:  Category', 'kidsa-core' ),
            array( 'description' => esc_html__( 'Display  categories', 'kidsa-core' ) )
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $all_terms ) ):?>
            ...
            esc_html__( ' Oops, there are no category.', 'kidsa-core' )
            ?>
        <?php endif; ?>
        </ul>
        <?php
    ...
    public function form( $instance ) {
        ...
        if (!empty($instance) && $instance['title']) {
            ...
            $title = esc_html__('Category', 'kidsa-core');
        ...
        $taxonomy = array(
            'category' => esc_html__('Blog Category', 'kidsa-core'),
            'packages-cat' => esc_html__('Packages Category', 'kidsa-core'),
            'project-cat' => esc_html__('project Category', 'kidsa-core'),
            'course-category' => esc_html__('Courses Category', 'kidsa-core'),
            'service-cat' => esc_html__('Service Category', 'kidsa-core')
        );
        $order_arr   = array(
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('taxonomy')) ?>"><?php esc_html_e('Taxonomy', 'kidsa-core'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')) ?>"><?php esc_html_e('Number', 'kidsa-core'); ?></label>
...
if ( ! function_exists( 'Kidsa_Category_Widget' ) ) {
    function Kidsa_Category_Widget() {
        register_widget( 'Kidsa_Category_Widget' );
    }

    add_action( 'widgets_init', 'Kidsa_Category_Widget' );
}